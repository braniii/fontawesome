...
\begin{document}
\title{The \texttt{fontawesome7} Package\thanks{This document corresponds to fontawesome7 version 7.3.1-1, dated 2026/08/09.}}
...
\subsection*{Updates}
This package corresponds to Font Awesome 7.3.1.\\
If a newer version is available on the Font Awesome website, check for updates at \url{https://ctan.org/pkg/fontawesome7}. If the latest version is not yet on CTAN, please open an issue at \url{https://github.com/braniii/fontawesome}.
