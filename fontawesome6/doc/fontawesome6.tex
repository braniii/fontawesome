...
\begin{document}
\title{The \texttt{fontawesome6} Package\thanks{This document corresponds to fontawesome6 version 6.7.2-4, dated 2026/08/10.}}
...
If a newer version is available on the Font Awesome website, check for updates at \url{https://ctan.org/pkg/fontawesome6}. If the latest version is not yet on CTAN, please open an issue at \url{https://github.com/braniii/fontawesome}.
